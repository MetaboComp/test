...
#'
#'
test_for_classification<-function(X,
                                Y,
                                ID,
                                scale = TRUE,
                                nRep = 5,
...
test_miss_mean_min<-0
test_nVar_mean_min<-0

test_miss_mean_mid<-0
test_nVar_mean_mid<-0

test_miss_mean_max<-0
test_nVar_mean_max<-0

test_time_mean<-0

for(i in 1:repeatMUVR)
{test_miss[[i]]<-test[[i]]$miss
...
for(i in 1:repeatMUVR)
{test_miss_mean_min<-test_miss_mean_min+test_miss[[i]][1]
test_nVar_mean_min<-test_nVar_mean_min+test_nVar[[i]][1]



test_miss_mean_mid<-test_miss_mean_mid+test_miss[[i]][2]
test_nVar_mean_mid<-test_nVar_mean_mid+test_nVar[[i]][2]



test_miss_mean_max<-test_miss_mean_max+test_miss[[i]][3]
test_nVar_mean_max<-test_nVar_mean_max+test_nVar[[i]][3]

test_time_mean<-test_time_mean+test_time[[i]][1]

}
test_miss_mean<-c(test_miss_mean_min,test_miss_mean_mid,test_miss_mean_max)/repeatMUVR
